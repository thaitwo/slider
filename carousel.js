...
var Slider = function () {
  function Slider(_ref) {
    var _ref$imageLinks = _ref.imageLinks,
        imageLinks = _ref$imageLinks === undefined ? [] : _ref$imageLinks,
        _ref$breadcrumb = _ref.breadcrumb,
        breadcrumb = _ref$breadcrumb === undefined ? true : _ref$breadcrumb,
    ...
    this.$container = (0, _jquery2.default)('#carousel');
    ...
    // If not passed, search for images and create array of links
        ...
        this.imageLinks = _lodash2.default.map((0, _jquery2.default)('#carousel img'), function (image) {
          return image.src;
        });
      }
  ...
  _createClass(Slider, [{
    ...
    value: function renderSlides() {
      ...
      var slides = this.imageLinks.map(function (link, index) {
        // if slide is first in gallery, add active class
        var slideClass = index === 0 ? 'slide active' : 'slide';
    ...
    value: function renderBreadcrumb() {
      ...
      this.$breadcrumbContainer = (0, _jquery2.default)('.carousel-breadcrumb');
    ...
    value: function activateBreadcrumb() {
      ...
      this.$breadcrumbContainer.on('click', 'li', function (event) {
        ...
        _this.updateBreadcrumbState(id);
      });
    }
    ...
    key: 'renderNavigationArrows',
    value: function renderNavigationArrows() {
      ...
      this.$nextArrow = (0, _jquery2.default)('#next');
      this.$prevArrow = (0, _jquery2.default)('#prev');
    ...
    key: 'activateNavigationArrows',
    value: function activateNavigationArrows() {
      var _this2 = this;
    ...
    key: 'removeCurrentSlide',
    value: function removeCurrentSlide(slide, direction) {
      if (direction === 'next') {
        (0, _jquery2.default)(slide).addClass('left');
      } else {
        (0, _jquery2.default)(slide).addClass('right');
      }

      setTimeout(function () {
        (0, _jquery2.default)(slide).removeClass('active right left');
      }, 1000);
    }
    ...
    key: 'showSlide',
    value: function showSlide(slide, direction) {
      if (direction === 'next') {
        (0, _jquery2.default)(slide).addClass('next');
      } else {
        (0, _jquery2.default)(slide).addClass('prev');
      }

      setTimeout(function () {
        (0, _jquery2.default)(slide).removeClass('next prev');
        (0, _jquery2.default)(slide).addClass('active');
      }, 1000);
    }
    ...
    key: 'activateKeyboardArrows',
    value: function activateKeyboardArrows() {
      var _this3 = this;
...
new Slider({
  imageLinks: ['../images/snow.jpg', '../images/valley.jpg', '../images/mountains.jpg', '../images/sunset.jpg', '../images/river.jpg'],
  breadcrumb: true,
  arrows: true,
  autoplay: false
});
